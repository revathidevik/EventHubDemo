...
namespace EventHubTest
{
    public class EventHubsHelper
    {
        ...
        public static void PushMessageToEventHubsAsync(AttachmentMetaData msg, string eventHubConnectionString)
        {
            ...
            SendMessagesToEventHub(msg);

            eventHubClient.CloseAsync();
        }

        // Creates an event hub client and sends 100 messages to the event hub.
        private static void SendMessagesToEventHub(AttachmentMetaData msg)
        {
            try
            {
                ...
                eventHubClient.SendAsync(new Microsoft.Azure.EventHubs.EventData(Encoding.UTF8.GetBytes(message)));
            }
